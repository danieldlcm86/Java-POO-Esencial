...
public class Supermercado {
    public static void main(String[] args){
        ...
        IProducto manzanas = new Fresco("MNZ", 1000, 1500, LocalDate.of(2026, 5, 8));
        IProducto helado = new Congelado("HLD", 800, 1000);
        IProducto papel = new Higiene("PAP", 500, 2500);
        IProducto peras = new Fresco("PER", 800, 1200, LocalDate.now().plusDays(50));
